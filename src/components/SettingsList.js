    ...
    render(){
        return(
            <div className="col" style={{marginTop:'10px'}}>
                ...
                <button className="btn ListButtons whitee shadow" onClick={()=>this.props.setSettings('Change Encryption Key')}>Change Encryption Key</button>
                <button className="btn ListButtons whitee shadow" onClick={()=>this.props.toggleTheme()}>Toggle Theme</button>
