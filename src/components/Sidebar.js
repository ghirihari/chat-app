            ...
            <div>
                ...
                <div className="row add-friends">
                    <div className="col icon-box">    
                        <svg onClick={()=>setMenu('Chats')} className={"sidebar-icons "+(props.menu==='Chats'?'selectedIcon':'')} xmlns="http://www.w3.org/2000/svg" viewBox="0 0 512.001 512.001">
                    ...
                    <div className="col icon-box">
                        <svg onClick={()=>props.mapMode()} className={"sidebar-icons "+(props.menu==='Friends-Map'?'selectedIcon':'')} xmlns="http://www.w3.org/2000/svg" viewBox="0 0 512.032 512.032">
                    ...
                    <div className="col icon-box">
                        <svg onClick={()=>setMenu('Add Friends')} className={"sidebar-icons "+(props.menu==='Add Friends'?'selectedIcon':'')} xmlns="http://www.w3.org/2000/svg" viewBox="0 0 512 512">
                    ...
                    <div className="col icon-box">
                        <svg onClick={()=>setMenu('Posts')} className={"sidebar-icons "+(props.menu==='Posts'?'selectedIcon':'')} xmlns="http://www.w3.org/2000/svg" viewBox="0 0 431.972 431.972">
                    ...
                    <div className="col icon-box">
                        <svg onClick={()=>setMenu('Settings')} className={"sidebar-icons "+(props.menu==='Settings'?'selectedIcon':'')} viewBox="0 0 512 512" xmlns="http://www.w3.org/2000/svg">
                ...
                <div style={{textAlign:'center'}}>
                    <label className="sub_Heading" style={{margin:'0px 15px'}}>{props.menu}</label>
                </div>                        

                {(props.menu==="Chats"||props.menu==="Friends-Map") &&
                    <div>
                        <MessageList 
                            recipient={props.recipient}
                            users={props.occupants} 
                            type={"request"}
                            setRec={props.setRec}
                ...
                {props.menu==="Add Friends" &&
                    <>
                    <div className="search shadow">
                        <div className="input-group add-friends-input">
                            <input type="text" className="form-control" placeholder="Search" onChange={props.fidTyped} value={props.fid}/>
                            <div className="input-group-append">
                                <button className="btn btn-dark"  type="button" onClick={props.searchUsers}>
                        ...
                        <div className="col">
                            <div className="row messages_list_item shadow">
                                <div className="col" style={{padding:'0px'}}>
                                    <img alt="DP" className="add-friend-tile"src={props.searched.photoURL} />
                                </div>
                                <div className="col" style={{alignSelf:'center'}}>
                                    <label className="add-friends-name">{props.searched.displayName}</label>
                                    <button className={props.addFriendClass} onClick={props.addFriend}>
                                        {props.addFriendStatus}                                            
                    ...
                    {props.error &&
                        <div className="col" style={{textAlign:'center', padding:'10px'}}>
                            <div className="col-12" style={{margin:'10px 0px'}}>  
                                <p className="message-list-name">{props.error}</p>
                            </div>
                        </div>
                    }
