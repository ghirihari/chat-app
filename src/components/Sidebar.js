            ...
            <div>
                ...
                <div className="row add-friends">
                    <div className="col icon-box">    
                        <svg onClick={()=>props.setMenu('Chats')} className="sidebar-icons" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 512.001 512.001">
                    ...
                    <div className="col icon-box">
                        <svg onClick={()=>props.mapMode()} className="sidebar-icons" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 512.032 512.032">
                    ...
                    <div className="col icon-box">
                        <svg onClick={()=>props.setMenu('Add Friends')} className="sidebar-icons" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 512 512">
                    ...
                    <div className="col icon-box">
                        <svg onClick={()=>props.setMenu('Posts')} className="sidebar-icons" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 431.972 431.972">
                    ...
                    <div className="col icon-box">
                        <svg onClick={()=>props.setMenu('Settings')} className="sidebar-icons" viewBox="0 0 512 512" xmlns="http://www.w3.org/2000/svg">
